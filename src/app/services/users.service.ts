...
export class UsersService {
  ...
  getAllFacultyGroup(): Observable<Users[]> {
    return this.http.get<Users[]>(`${baseUrl}/facultyGroup`);
  }

  getAllGroup(): Observable<Users[]> {
    return this.http.get<Users[]>(`${baseUrl}/group`);
  }
